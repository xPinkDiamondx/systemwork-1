                ...
                <div class="gnavi">
                    <div class="gnavi">
                        <table>
                            ...
                            <td class="gmavi_td"><a href="01menberlist.html">運営紹介</a></td>
                        </table>
                    </div>

                <div id="main">
                    <h2 class="list_main_h2">”動物サーバー”へようこそ！</h2>

                    <div>
                        <p>
                            動物サーバーはPVE、職業,そしてmcMMOによるサバイバル生活が送れます
                            また、ギルドに所属して仲間と共に冒険や他ギルドと決闘をして賞金を手にしたり、生産をしてお金を稼ぐことができます
                            </p>
                    </div>
